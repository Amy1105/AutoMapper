...
public sealed class MappingExpression(MemberList memberList, TypePair types) 
    : MappingExpressionBase<object, object, IMappingExpression>(memberList, types), IMappingExpression
{
